...
export const ap = new Aprendiz("Juan Diego", "Alzate Paez", "avatar.png", 30, NivelEducativo.POSGRADO, cursos);
...
function mostrarEstadisticas(aprendiz: Aprendiz):void{    
    ...
    trElement.innerHTML = `<td><b>Cursos certificdados</b></td><td>${numeroCertificados}</td>`;
